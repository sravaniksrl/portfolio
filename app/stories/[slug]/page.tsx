...
// NOTE: slideshow.css is NOT exported by the package, so keep this commented:
...
export default function StoryViewer({ params }: any) {
  ...
  // At this point `story` is guaranteed to exist
  const items: Photo[] = story.photoIds
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 md:py-14">
      <div className="rounded-3xl bg-white/5 p-6 ring-1 ring-white/10 shadow-soft">
        ...
        <p className="mt-2 text-sm text-zinc-300/80 md:text-base">
          {story.subtitle}
        </p>
        <button
          type="button"
